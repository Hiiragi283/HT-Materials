...
object HTMaterialCategory : DisplayCategory<HTMaterialDisplay> {
    override fun getCategoryIdentifier(): CategoryIdentifier<HTMaterialDisplay> = HMReiPlugin.MATERIAL

    override fun getTitle(): Text = Text.of(HTMaterialsAPI.MOD_NAME)
    ...
    private class HTScrollableSlotsWidget(
        ...
        override fun render(
            ...
            scissor(context, scrolling.scissorBounds).use {
            ...
            scissor(context, scrolling.bounds).use {
