...
sealed class HTMaterialContent<T>(val shapeKey: HTShapeKey, val objClass: Class<T>, val type: Type) {
    ...
    abstract class Block(shapeKey: HTShapeKey) : HTMaterialContent<MCBlock>(shapeKey, MCBlock::class.java, Type.BLOCK) {
    ...
    abstract class Fluid(shapeKey: HTShapeKey) : HTMaterialContent<MCFluid>(shapeKey, MCFluid::class.java, Type.FLUID) {
    ...
    abstract class Item(shapeKey: HTShapeKey) : HTMaterialContent<MCItem>(shapeKey, MCItem::class.java, Type.ITEM) {
